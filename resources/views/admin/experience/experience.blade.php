...
@section('content')
    <div class="card mb-4">
        <div class="card-header">All Experiences</div>
        <div class="card-body">
            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                        ...
                        <tbody>
                            @foreach ($experiences as $experience)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('experiences.destroy', ['experience' => $experience]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{ route('experiences.edit', ['experience' => $experience]) }}"
                ...
                <div class="pagination__panel mt-2">
                    ...
                    <div class="item__panel_cont">
                        <a class="item__panel_link" href="{{ route('experiences.create') }}">
                            <button class="item__btn">Add</button>
                        </a>
                        <a class="item__panel_link" href="{{ route('recycleBin', ['table' => 'experiences']) }}">
