        ...
        <div class='header__cont flex'>
            <div class='header__logo'>
                <a class='logo__link' href='{{ route('index') }}'>
                    <svg class='logo__svg' width='50' height='50' viewBox='0 0 132 132' fill='none'>
                        <g>
                            <path
                    ...
                    <svg class='logo__svg_border' xmlns='http://www.w3.org/2000/svg' width='50' height='50'
            ...
            <nav class='headert__nav'>
                <ul class='header__list home-header__list flex'>
                    <li class='header__item'>
                        <a class='header__link' href='@if ($title == '
                            Portfolio'){{ '#home' }}
                        @else {{ route('index', '#home') }}@endif'>home</a>
                    </li>
                    <li class='header__item'>
                        <a class='header__link'
                        href='@if ($title == '
                            Portfolio'){{ '#skills' }}
                        @else {{ route('index', '#skills') }}@endif'>skills</a>
                    </li>
                    <li class='header__item'>
                        <a class='header__link' href='@if ($title == '
                            Portfolio'){{ '#education' }}
                        @else {{ route('index', '#education') }}@endif'>education</a>
                    </li>
                    <li class='header__item'>
                        <a class='header__link' href='@if ($title == '
                            Portfolio'){{ '#certificate' }}
                        @else {{ route('index', '#certificate') }}@endif'>certificate</a>
                    </li>
                    <li class='header__item'>
                        <a class='header__link' href='@if ($title == '
                            Portfolio'){{ '#experience' }}
                        @else {{ route('index', '#experience') }}@endif'>experience</a>
                    </li>
                    <li class='header__item'>
                        <a class='header__link' href='@if ($title == '
                            Portfolio'){{ '#projects' }}
                        @else {{ route('index', '#projects') }}@endif'>projects</a>
                    </li>
                    <li class='header__item'>
                        <a class='header__link' href='@if ($title == '
                            Portfolio'){{ '#projects-back' }}
                        @else {{ route('index', '#projects-back') }}@endif'>back projects</a>
                    </li>
                    <li class='header__item'>
                        <a class='header__link' href='@if ($title == '
                            Portfolio'){{ '#contact' }}
                        @else {{ route('index', '#contact') }}@endif'>contact</a>
                    </li>
                </ul>
            </nav>
    ...
    <nav class='headert__mobile-nav'>
        <ul class='header__list header__mobile-list'>
            <li class='header__item header__mobile-item'>
                <a class='header__mobile-link' href='@if ($title == '
                    Portfolio'){{ '#home' }}
                @else {{ route('index', '#home') }}@endif'>home</a>
            </li>
            <li class='header__item header__mobile-item'>
            ...
            @auth('web')
                <button class='btn header__btn header__btn_sign flex'>
                    <span class='btn__span header__btn_span'>sign in</span>
                </button>
            @endauth
