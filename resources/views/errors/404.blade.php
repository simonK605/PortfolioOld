...
<body>
    @include('components.header', ['title' => '404 not found'])
    <main>
        <div class="error">
            <div class="wrapper">
                <div class="error__cont">
                    <div class="error__info">
                        <h3 class="error__message">Oops! Page not found.</h3>
                        <a href="{{ route('index') }}">
                            <button class="error__button btn">
                                <span class="btn__span">
                                    Back Home in 00:00:0<span class="error__time">9</span>
                                </span>
                            </button>
                        </a>
                    </div>
                    <div class="error__404">
                        <div class="error__404_message">
                            <span>4</span>
                            <div class="error__logo">
                                <a class="logo__link error__logo_link" href="http://portfolio.loc">
                                    <svg class="error__svg" width="170" height="170" viewBox="0 0 132 132" fill="none">
                                        <g>
                                            <path d="M73.6562 75.0625C73.6562 73.2917 73.0312 71.9375 71.7812 71C70.5312 70.0417 68.2812 69.0417 65.0312 68C61.7812 66.9375 59.2083 65.8958 57.3125 64.875C52.1458 62.0833 49.5625 58.3229 49.5625 53.5938C49.5625 51.1354 50.25 48.9479 51.625 47.0312C53.0208 45.0938 55.0104 43.5833 57.5938 42.5C60.1979 41.4167 63.1146 40.875 66.3438 40.875C69.5938 40.875 72.4896 41.4688 75.0312 42.6562C77.5729 43.8229 79.5417 45.4792 80.9375 47.625C82.3542 49.7708 83.0625 52.2083 83.0625 54.9375H73.6875C73.6875 52.8542 73.0312 51.2396 71.7188 50.0938C70.4062 48.9271 68.5625 48.3438 66.1875 48.3438C63.8958 48.3438 62.1146 48.8333 60.8438 49.8125C59.5729 50.7708 58.9375 52.0417 58.9375 53.625C58.9375 55.1042 59.6771 56.3438 61.1562 57.3438C62.6562 58.3438 64.8542 59.2812 67.75 60.1562C73.0833 61.7604 76.9688 63.75 79.4062 66.125C81.8438 68.5 83.0625 71.4583 83.0625 75C83.0625 78.9375 81.5729 82.0312 78.5938 84.2812C75.6146 86.5104 71.6042 87.625 66.5625 87.625C63.0625 87.625 59.875 86.9896 57 85.7188C54.125 84.4271 51.9271 82.6667 50.4062 80.4375C48.9062 78.2083 48.1562 75.625 48.1562 72.6875H57.5625C57.5625 77.7083 60.5625 80.2188 66.5625 80.2188C68.7917 80.2188 70.5312 79.7708 71.7812 78.875C73.0312 77.9583 73.6562 76.6875 73.6562 75.0625Z" fill="#00D646"></path>
                                        </g>
                                        <mask id="path-2-inside-1" fill="white">
                                            <path d="M66 6.60002C66 2.95495 68.9622 -0.0341568 72.5891 0.32975C78.9959 0.972588 85.2863 2.5508 91.2571 5.02397C99.2646 8.34078 106.54 13.2023 112.669 19.331C118.798 25.4596 123.659 32.7354 126.976 40.7429C130.293 48.7504 132 57.3328 132 66C132 74.6673 130.293 83.2496 126.976 91.2571C123.659 99.2646 118.798 106.54 112.669 112.669C106.54 118.798 99.2646 123.659 91.2571 126.976C85.2863 129.449 78.9959 131.027 72.5891 131.67C68.9622 132.034 66 129.045 66 125.4C66 121.755 68.9662 118.843 72.5829 118.388C77.2548 117.801 81.8372 116.59 86.2057 114.781C92.6117 112.127 98.4323 108.238 103.335 103.335C108.238 98.4323 112.127 92.6117 114.781 86.2057C117.434 79.7997 118.8 72.9338 118.8 66C118.8 59.0662 117.434 52.2003 114.781 45.7943C112.127 39.3884 108.238 33.5677 103.335 28.6648C98.4323 23.7619 92.6117 19.8726 86.2057 17.2192C81.8372 15.4097 77.2548 14.1991 72.5829 13.612C68.9662 13.1575 66 10.2451 66 6.60002Z"></path>
                                        </mask>
                                    </svg>
                                </a>
                            </div>
        ...
        <footer class='footer error__footer'>
            <div class='wrapper'>
                <div class='footer__cont'>
                    ...
                    <h3 class='footer__inside'>© 2019 - 2021 Simon. All rights reserved.</h3>
                </div>
            </div>
        </footer>
    </main>
