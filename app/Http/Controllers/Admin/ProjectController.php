...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->countsArr['projects'] = $projects;
        return view('admin.project.project', $this->countsArr);
    }
    ...
    {
        return view('admin.project.create', $this->countsArr);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.project.edit', $this->countsArr);
    }
