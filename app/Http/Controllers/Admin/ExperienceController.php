...
class ExperienceController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->countsArr['experiences'] = $experiences;
        return view('admin.experience.experience', $this->countsArr);
    }
    ...
    {
        return view('admin.experience.create', $this->countsArr);
    }
    ...
    public function edit($id)
    {
        ...
        $this->countsArr['experience'] = $item;
        return view('admin.experience.edit', $this->countsArr);
    }
